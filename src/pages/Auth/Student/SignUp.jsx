    ...
    <div className='flex min-h-screen w-full flex-1 bg-hero-pattern' style={{ background: 'linear-gradient(140.21deg, rgba(243, 233, 233, 0.4) -6.93%, rgba(246, 246, 246, 0) 98.1%)' }}>
      ...
      <div className='flex flex-[4] lg:flex-1 px-10 justify-center'>
        <div className='flex flex-col flex-1'>
          <div className='flex items-end 2xl:items-center justify-end 2xl:justify-center flex-[2] flex-col'>
      ...
      <div className='flex flex-[6] lg:flex-1 '>
        <div className='flex flex-col flex-1 px-4 md:px-4 py-6 justify-center items-center text-center'>
          <div className='flex flex-col bg-white h-full px-4 md:px-8 lg:px-10 xl:px-16 py-10 w-4/5'>
            <div className='py-2'>
